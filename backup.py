...
class Playoffs(object):
    ...
    def predict(self):
        ...
        #round 1 contestants
        t1, t2 = Teams.order(metropolitan.first, atlantic.first)
        t3, t4 = metropolitan.second, metropolitan.third
        t5, t6 = atlantic.second, atlantic.third
        t7, t8 = Teams.order(wildcards.first, wildcards.second)
        ...
        print("Round 1:")
        print('Game 1: %-25s vs %-25s' % (t1.name, t2.name), end='')
        t1, t2 = Teams.order(central.first, pacific.first)
        t3, t4 = central.second, central.third
        t5, t6 = pacific.second, pacific.third
        t7, t8 = Teams.order(wildcards.first, wildcards.second)
